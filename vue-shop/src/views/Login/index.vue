...
const rules = {
  ...
  password: [
    ...
    { min: 5, max: 14, message: "長度在 5 到 14 個字元", trigger: "blur" },
  ],
  agree: [
    {
...
.login-section {
  background: url("@/assets/images/shop-bg.jpg") no-repeat center / cover;
  height: 488px;
  position: relative;
  .wrapper {
    width: 380px;
